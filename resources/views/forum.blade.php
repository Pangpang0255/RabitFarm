...
<div class="social-community-section">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3">
                <a href="https://shopee.co.id" target="_blank" class="social-card shopee">
                    <div class="social-icon">
                        <svg width="70" height="70" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M18.5 18.5l-5.5-5.5m0 0l-5.5 5.5m5.5-5.5V22M3 7h18m-2 0l-2-4M5 7L7 3m10 11a2 2 0 100-4 2 2 0 000 4z"/>
                        </svg>
                    </div>
                    <h4>Shopee</h4>
            ...
            <div class="col-md-3">
                <a href="https://tiktok.com" target="_blank" class="social-card tiktok">
                    <div class="social-icon">
                        <svg width="70" height="70" viewBox="0 0 24 24" fill="currentColor">
